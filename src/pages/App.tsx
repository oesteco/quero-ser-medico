      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div>
            ...
            />
            <h3 className="text-xl font-semibold mb-1 mt-4">Laboratório de Anatomia</h3>
          ...
          <div>
            ...
            />
            <h3 className="text-xl font-semibold mb-1 mt-4">Laboratório de Microscopia</h3>
          ...
          <div>
            ...
            />
            <h3 className="text-xl font-semibold mb-1 mt-4">Centro de Simulação</h3>
    ...
    <div className="bg-white text-gray-800">
      ...
      <header className="bg-violet-500 text-white py-16 px-6 text-center">
        ...
        <p className="text-lg md:text-xl max-w-3xl mx-auto">
          Entre direto em Medicina no Paraguai, com apoio completo para o Revalida, mensalidade acessível e estrutura moderna.
        </p>
      </header>
      ...
      <section className="py-10 px-6 bg-white">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <img src="/Folder_1.png" alt="Laboratório real" className="rounded-xl shadow w-full h-64 object-cover" />
          <img src="/Folder_2.png" alt="Sala com alunos" className="rounded-xl shadow w-full h-64 object-cover" />
          <img src="/Folder_3.png" alt="Prática médica" className="rounded-xl shadow w-full h-64 object-cover" />
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <h2 className="text-3xl font-bold text-center mb-10 text-blue-900">
          Por que brasileiros estão migrando para o Paraguai?
        </h2>
      ...
      <section className="py-16 px-6 bg-gray-50 text-center">
        ...
        <p className="text-md text-gray-700 mb-10 max-w-2xl mx-auto">
          Enquanto a concorrência para uma vaga de Medicina no Brasil passa de 300 candidatos por vaga, o Revalida é um processo direto e possível com preparação focada.
        </p>
          ...
          {depoimentos.map((d, i) => (
            <div key={i} className="bg-white rounded-xl shadow p-6 border border-gray-200 text-center">
              <img
                src={d.foto}
                alt={d.nome}
                className="w-16 h-16 rounded-full object-cover mb-4 mx-auto border-2 border-blue-500"
              />
          ...
          {faqData.map((item, index) => (
            <div key={index} className="border rounded-xl shadow">
              <button
                ...
                className="w-full text-left p-4 font-semibold text-blue-800 focus:outline-none flex justify-between items-center"
              >
                <span>❓ {item.pergunta}</span>
                <span>{aberta === index ? '▲' : '▼'}</span>
              </button>
              {aberta === index && (
                <div className="px-4 pb-4 text-gray-700">{item.resposta}</div>
              )}
            </div>
          ))}
        </div>
